...
* 提交要求 
  * 实验部分:
    ...
    * **选做Pass**在`2022/12/31`之前都可以联系助教验收，然后由助教统一安排线下验收，该部分由学生现场演示，**不需要**撰写实验报告。
    * 
...
* 迟交规定
  * `Soft Deadline` :
    ...
    **阶段一**：2022/12/17 23:59:59 (北京标准时间，UTC+8)  
  
    **阶段二**：2022/12/31 23:59:59 (北京标准时间，UTC+8) 
  
  * `Hard Deadline`：
  
    **阶段一**：2022/12/22 23:59:59 (北京标准时间，UTC+8)  
  
    **阶段二**：2023/01/14 23:59:59 (北京标准时间，UTC+8) 
